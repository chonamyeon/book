...
- ❗ **캐릭터 페르소나**:
  - **스텔라**: 현실적인 질문자. 대중이 궁금해할 날카로운 **핵심 질문**("왜 대부분 성공하지 못할까?" 등)을 던지는 역할.
...
- ❗ **스토리텔링 흐름 (준수 필수)**:
  1. [1~4턴: 상황] 현실 밀착형 공감 상황극으로 시작
  2. [5~8턴: 질문] **갈등 질문** 제기 (근본적인 질문 던지기)
...
- **분량**: 40턴 기준 총 글자 수 **2500~3000자** 사이를 엄격히 준수하세요.
